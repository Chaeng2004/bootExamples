...
try {
    $stmt = $pdo->prepare("SELECT b.reference, b.status, 
    b.seat_number, b.passenger_type, b.price, b.remarks, bus.bus_number, 
    bus.location, bus.destination, bus.bus_type, bus.date, bus.departure_time, 
    bus.arrival_time
    FROM bookings b 
